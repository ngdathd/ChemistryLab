package com.ngdat.chemistrylab.database;
...
import com.ngdat.chemistrylab.fragment.PeriodicTableFragment;
import com.ngdat.chemistrylab.tooltip.ItemTip;
...
public class DatabaseManager {
    ...
    private static final String APP_DATA_PATH = Environment.getDataDirectory().getPath() + "/data/com.ngdat.chemistrylab/";

    private static final String DATABASE_FOLDER_NAME = "database";
    private static final String DATABASE_NAME = "database-test";
    private static final String DATABASE_DATA_PATH = Environment.getDataDirectory().getPath() + "/data/com.ngdat.chemistrylab/" + DATABASE_FOLDER_NAME + "/" + DATABASE_NAME;
